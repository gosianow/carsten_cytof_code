...
setwd("/Users/mark/Dropbox/Work/DB_projects/Mark_Carsten_CYTOF/CK_2016-06-28_01")
...
dummy <- mapply(writeOutCluster,clustmList,fcs,f,keep="CD4.T.cell")
dummy <- mapply(writeOutCluster,clustmList,fcs,f,keep="CD8.T.cell")
