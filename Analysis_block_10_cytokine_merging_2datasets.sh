...
while [[ ${1} ]]; do
  case "${1}" in
    ...
    shift
    ;;
    --cytokines_merging_v2)
    cytokines_merging_v2=${2}
    shift
    ;;
    --data_name1)
    data_name1=${2}
...
if ${cytokines_merging_v2}; then
  ...
  ### Plot frequencies for the top significant clusters -  top 10
