...
## Remove tx samples from metadata
...
if(identical(levels(md$data), c("data23", "data29")) && identical(levels(md$day), c("base")) && identical(levels(md$response), c("NR", "R", "HD")) && identical(levels(md$data_day), c("data23.base", "data29.base"))){
