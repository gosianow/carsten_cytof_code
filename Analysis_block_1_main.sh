...
if ${data_normalization}; then
  ...
  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' data_prefix='${prefix_data}${prefix_panel}' data_outdir='010_data' path_metadata='${METADATA}/${file_metadata}' path_panel='${PANELS}/${file_panel}'" $RCODE/01_data_normalization.R $ROUT/01_data_normalization.Rout
...
if ${pcascores}; then
  echo ">>> 01_pcascores"
  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' pcas_prefix='${prefix_data}${prefix_panel}' pcas_outdir='020_pcascores' path_data='010_data/${prefix_data}${prefix_panel}expr_raw.rds' path_metadata='${METADATA}/${file_metadata}' path_panel='${PANELS}/${file_panel}'" $RCODE/01_pcascores.R $ROUT/01_pcascores.Rout
...
if ${flowsom}; then
  echo ">>> 02_flowsom"
  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' flowsom_prefix='${prefix_data}${prefix_panel}${prefix_pca}${prefix_clust}' flowsom_outdir='030_heatmaps' path_data='010_data/${prefix_data}${prefix_panel}expr_raw.rds' path_clustering_observables='030_heatmaps/${prefix_data}${prefix_panel}${prefix_pca}clustering_observables.xls' nmetaclusts=${nmetaclusts} rand_seed_consensus=${rand_seed_consensus}" $RCODE/02_flowsom.R $ROUT/02_flowsom.Rout
  tail $ROUT/02_flowsom.Rout

  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' codes_prefix='${prefix_data}${prefix_panel}${prefix_pca}${prefix_clust}' codes_outdir='030_heatmaps' path_codes='030_heatmaps/${prefix_data}${prefix_panel}${prefix_pca}${prefix_clust}codes.xls' pdf_width=22 pdf_height=7" $RCODE/02_som_codes.R $ROUT/02_som_codes.Rout
...
if ${flowsom_validation}; then
  ...
  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' flowsom_prefix='${prefix_data}${prefix_panel}${prefix_pca}${prefix_clust}' flowsom_outdir='030_flowsom_validation' path_data='010_data/${prefix_data}${prefix_panel}expr_raw.rds' path_clustering_observables='030_heatmaps/${prefix_data}${prefix_panel}${prefix_pca}clustering_observables.xls' nmetaclusts=${nmetaclusts} rand_seed_consensus=${rand_seed_consensus}" $RCODE/02_flowsom_validation.R $ROUT/02_flowsom_validation.Rout
...
if ${runtsne}; then
  echo ">>> 03_runtsne"
  # on raw data
  R33 CMD BATCH --no-save --no-restore "--args rwd='$RWD' tsne_prefix='${prefix_data}${prefix_panel}${prefix_pca}raw_' tsne_outdir='040_tsnemaps' path_data='010_data/${prefix_data}${prefix_panel}expr_raw.rds' path_metadata='${METADATA}/${file_metadata}'  path_clustering_observables='030_heatmaps/${prefix_data}${prefix_panel}${prefix_pca}clustering_observables.xls' tsne_pmin=${tsne_pmin}" $RCODE/03_runtsne.R $ROUT/03_runtsne.Rout
