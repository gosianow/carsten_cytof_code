...
setwd("/Users/mark/Dropbox/Work/DB_projects/Mark_Carsten_CYTOF/CK_2016-06-23_CD4")
...
fcsN <- sapply(fcs,nrow)
table(rep(names(fcsN),fcsN))
...
(ns <- pmin(ts,500))  # per-sample, how many cells to downsample
...
#limma::plotMDS(prop,col=as.numeric(as.factor(gsub("[1-9]","",colnames(prop)))))
